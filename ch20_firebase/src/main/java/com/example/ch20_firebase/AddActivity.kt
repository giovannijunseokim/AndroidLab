...
class AddActivity : AppCompatActivity() {
    ...
    private fun saveStore(){
        ...
        MyApplication.db.collection("news")
            .add(data)
            .addOnSuccessListener { uploadImage(it.id) }
            .addOnFailureListener { Log.w("kim", "data save error",it)}
    }
    private fun uploadImage(docId: String){
        ...
        imgRef.putFile(file)
            .addOnFailureListener{Log.d("kim", "failure....")}
            .addOnSuccessListener { Toast.makeText(this,"데이터가 저장되었습니다.",
            Toast.LENGTH_SHORT)
            finish()}
    }
}